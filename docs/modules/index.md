...
v-stdlib unversioned; **6 modules**, **36 public labels**. Generated from `dist/vsl-manifest.json` by `tools/write-module-frontmatter.py` (`make frontmatter`) — do not edit by hand.
...
| [`VSLTASK`](vsltask.md) | 7 | VistA TaskMan persistent-listener adapter (the process seam) |

...
- [vsl-wrapping-baseline-audit](vsl-wrapping-baseline-audit.md) — 2026-06-28 dual-engine adversarial audit → the wrapping baseline (`docs/proposals/vista-library-wrapping-baseline.md`) + four defects (VSLSEC default-duz UNDEF [✅ FIXED], VSLIO RED on IRIS [✅ FIXED], VSLFS E-flag/internal-doc [✅ FIXED — doc, not code], VSLTASK "@"); green YDB suites masked them. Corrects [[m2-vslio]]. **Only VSLTASK (4) still open.**

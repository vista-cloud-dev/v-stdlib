...
- [vsl-wrapping-baseline-audit](vsl-wrapping-baseline-audit.md) — 2026-06-28 dual-engine adversarial audit → the wrapping baseline (`docs/proposals/vista-library-wrapping-baseline.md`) + FOUR open defects (VSLSEC default-duz UNDEF, **VSLIO RED on IRIS**, VSLFS E-flag, VSLTASK "@"); green YDB suites masked them. Corrects [[m2-vslio]].
